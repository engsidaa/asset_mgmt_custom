...
fixtures = [
    {
        "dt": "Custom Field",
        "filters": [["dt", "in", ["Asset", "Asset Repair", "Location", "Asset Movement", "Asset Movement Item", "Asset Category", "Asset Category Account", "Asset Maintenance Contract", "Asset Maintenance", "Asset Maintenance Task", "Branch", "Maintenance Team Member", "Material Request", "User"]]],
    },
    {
        "dt": "Property Setter",
...
scheduler_events = {
    "daily": [
        ...
        "asset_mgmt_custom.tasks.send_daily_digest_email",
    ],
    "weekly": [
